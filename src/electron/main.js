...
async function createWindow() {
    ...
    // If you'd like to set up auto-updating for your react,
    ...
    const callback = function (success, initialStore) {
        console.log(`${!success ? "Un-s" : "S"} Successfully retrieved store in main process.`);
    ...
    win.on("closed", () => {
        ...
        // in an array if your react supports multi windows, this is the time
...
// Needs to be called before react is ready;
...
app.on("web-contents-created", (event, contents) => {
    contents.on("will-navigate", (contentsEvent, navigationUrl) => {
        ...
        // Log and prevent the react from navigating to a new page if that page's origin is not whitelisted
    ...
    contents.on("will-redirect", (contentsEvent, navigationUrl) => {
        ...
        // Log and prevent the react from redirecting to a new page
        if (!validOrigins.includes(parsedUrl.origin)) {
            console.error(
...
// built-ins are modules such as "react"
